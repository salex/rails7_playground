...
class ThingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thing" do
    assert_difference("Thing.count") do
      post things_url, params: { thing: { content: @thing.content, date: @thing.date, title: @thing.title } }
    end
  ...
  test "should update thing" do
    patch thing_url(@thing), params: { thing: { content: @thing.content, date: @thing.date, title: @thing.title } }
